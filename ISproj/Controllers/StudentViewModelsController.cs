...
namespace ISproj.Controllers
{
    public class StudentViewModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Address,Surname,Birthdate,CNP")] StudentViewModel studentViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Address,Surname,Birthdate,CNP")] StudentViewModel studentViewModel)
        {
